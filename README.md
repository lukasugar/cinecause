...
Contributor setup, environment, database operations, verification commands, and rollback notes have been moved to [`technical_details.md`](technical_details.md).
